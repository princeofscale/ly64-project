...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/40 to-violet-50/40 py-12 px-4 relative overflow-hidden">
      <div className="fixed top-0 right-0 w-[600px] h-[600px] bg-blue-200/30 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/4 pointer-events-none" />
      <div className="fixed bottom-0 left-0 w-[500px] h-[500px] bg-violet-200/30 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/4 pointer-events-none" />
      <div className="fixed top-1/2 left-1/2 w-[400px] h-[400px] bg-fuchsia-200/20 rounded-full blur-[120px] -translate-y-1/2 -translate-x-1/2 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-white/60 rounded-2xl p-8 shadow-2xl shadow-blue-900/10 animate-fade-in ring-1 ring-slate-200/50">
          <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-bold bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 bg-clip-text text-transparent mb-2">Создать аккаунт</h1>
            <p className="text-sm text-slate-500">Шаг {step} из {totalSteps}</p>
          </div>

          <div className="mb-8">
            <div className="h-1.5 bg-slate-100 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-blue-500 via-indigo-500 to-violet-500 rounded-full transition-all duration-500 ease-out shadow-sm shadow-blue-500/40"
          ...
          <div className="flex justify-between mt-8 pt-6 border-t border-slate-100">
            ...
            {step < totalSteps ? (
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 hover:from-blue-700 hover:via-indigo-700 hover:to-violet-700 disabled:from-slate-300 disabled:via-slate-300 disabled:to-slate-300 text-white font-semibold rounded-xl transition-all shadow-lg shadow-indigo-600/25 hover:shadow-xl hover:shadow-indigo-600/40 disabled:shadow-none flex items-center gap-2 disabled:cursor-not-allowed active:scale-[0.98]"
              >
                Далее
