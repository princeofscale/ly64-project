...
export const RocketSvg = memo(function RocketSvg({ running, crashed }: RocketSvgProps) {
  return (
    ...
    >
      ...
      {running && !crashed && (
        <>
          <path className="flame-outer" d="M26 58 L34 80 L42 58 Z" fill="url(#rflame)" />
          <path className="flame-inner" d="M28.5 58 L34 72 L39.5 58 Z" fill="#fef9c3" />
          <circle className="flame-core" cx="34" cy="70" r="3.5" fill="#fefce8" />
        </>
      )}
