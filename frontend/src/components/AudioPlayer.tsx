    ...
    <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/30 rounded-2xl p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-800/50 rounded-xl p-3 text-xs text-gray-400">
          <p className="mb-1">
            📌 <strong className="text-white">Важно:</strong> Текст будет воспроизведён {playCount}{' '}
            раза.
          </p>
          <p>
            Во время первого прослушивания запишите основные мысли, во время второго — уточните
            детали.
          </p>
        </div>
      </div>
