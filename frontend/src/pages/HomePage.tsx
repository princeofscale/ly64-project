        ...
        <div className="relative container-wide py-16 lg:py-24">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-lg sm:text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              {isAuthenticated
                ? motivation
                : 'Учебный проект с заданиями из реальных экзаменов, персональным планом обучения и аналитикой прогресса'}
            </p>
      ...
      <section className="py-12 bg-slate-50 border-y border-slate-100">
        <div className="container-wide">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-slate-900 mb-1">
                {stats.solvedQuestionsCount > 0 ? `${stats.solvedQuestionsCount.toLocaleString()}+` : '10 000+'}
              </div>
              <div className="text-sm text-slate-500">решённых задач</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-slate-900 mb-1">95%</div>
              <div className="text-sm text-slate-500">поступают</div>
            </div>
            <div className="text-center">
