...
function HomePage() {
 ...
 <div className="inline-flex items-center gap-2 px-4 py-2 mb-6  border border-slate-200 rounded-full shadow-sm" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
 ...
 <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold  mb-6 tracking-tight" style={{ color: 'var(--color-text)' }}>
 {isAuthenticated ? (
 greeting
 ) : (
 <>
 ...
 <div
 key={index}
 className="p-6  border border-slate-200 rounded-2xl hover:shadow-lg hover:border-slate-300 transition-all group" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
 <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center mb-4 group-hover:bg-blue-100 transition-colors">
 <feature.icon className="w-6 h-6 text-blue-600" />
 </div>
 <h3 className="text-lg font-semibold  mb-2" style={{ color: 'var(--color-text)' }}>{feature.title}</h3>
 ...
 <h3 className="text-xl font-semibold  mb-2" style={{ color: 'var(--color-text)' }}>{label}</h3>
 ...
 <h3 className="text-xl font-semibold  mb-2" style={{ color: 'var(--color-text)' }}>{item.title}</h3>
 ...
 <h2 className="text-3xl font-bold  mb-6" style={{ color: 'var(--color-text)' }}>Свяжитесь с нами</h2>

 <div className="space-y-4">
 <div className="flex items-start gap-4">
 <div className="w-10 h-10  border border-slate-200 rounded-lg flex items-center justify-center shrink-0" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
 ...
 <h2 className="text-3xl font-bold  mb-6" style={{ color: 'var(--color-text)' }}>Сроки приёма</h2>

 <div className=" border border-slate-200 rounded-2xl p-6" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
 <div className="space-y-4">
