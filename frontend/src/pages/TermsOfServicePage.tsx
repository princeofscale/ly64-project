        ...
        <div className="bg-white border border-slate-200 shadow-lg rounded-2xl p-8">
          ...
          <div className="prose prose-blue max-w-none">
            ...
            <p className="text-slate-700 mb-4">
              Настоящее Пользовательское соглашение регулирует отношения между авторами
              учебного проекта по подготовке к поступлению в Лицей-интернат №64 г. Саратова и пользователями
              проекта. Данный проект является студенческим и не связан официально с лицеем.
            </p>
            ...
            <p className="text-slate-700 mb-4">
              ...
              адресу: princeofscale812@proton.me и/или telegram: @tieruser
            </p>
