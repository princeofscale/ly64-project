...
function SpinWheelPage() {
 ...
 <h3 className="text-xl font-bold  mb-4" style={{ color: 'var(--color-text)' }}>Настроить варианты</h3>

 <div className="space-y-4">
 <div>
 <label htmlFor="spin-wheel-input" className="block text-slate-600 text-sm mb-2">
