...
import { vprBiology8Variants, VprBiology8Variant, VprBiology8Task } from '../data/vpr-biology8-variants';
...
export default function VprBiology8TestPage() {
  const navigate = useNavigate();
  const location = useLocation();
  const { grade } = location.state || {};

  const [phase, setPhase] = useState<TestPhase>('select');
  const [selectedVariant, setSelectedVariant] = useState<VprBiology8Variant | null>(null);
  ...
  if (phase === 'select') {
    return (
      <div className="min-h-screen bg-gray-950 relative overflow-hidden py-12 px-4">
        ...
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-emerald-500/20 rounded-full blur-[120px]" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl font-bold bg-gradient-to-r from-green-400 via-emerald-400 to-red-400 bg-clip-text text-transparent mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {vprBiology8Variants.map((variant, index) => (
              <button
                key={variant.id}
                onClick={() => handleSelectVariant(variant)}
                className="group bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-xl border border-green-500/50 hover:border-green-400 rounded-2xl p-6 text-left transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(251,191,36,0.3)] animate-scale-in"
          ...
          <div className="mt-8 p-6 bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-2xl">
            <h3 className="text-lg font-semibold text-white mb-3 flex items-center gap-2">
              <span>ℹ️</span> Особенности ВПР по биологии для 8 класса
            </h3>
            <ul className="space-y-2 text-gray-300 text-sm">
              <li>• <strong>20 заданий:</strong> разнообразные типы вопросов</li>
              <li>• <strong>Темы:</strong> ткани животных, систематика, развитие организмов, паразиты, классы животных</li>
              <li>• <strong>Время:</strong> 1 час 30 минут (90 минут)</li>
              <li>• <strong>Форматы:</strong> выбор ответов, сопоставление, работа с рисунками, развёрнутые ответы</li>
              <li>• <strong>Навыки:</strong> знание анатомии, систематики, экологии, эволюции животных</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 text-center animate-scale-in">
            ...
            <span className="px-4 py-2 bg-green-500/20 text-green-400 rounded-xl text-sm border border-green-500/30 inline-block">
              ВПР Биология 8 класс
            </span>

            <div className="mt-6 mb-8 p-6 bg-gray-800/50 rounded-2xl">
              <div className="text-5xl font-bold bg-gradient-to-r from-green-400 via-emerald-400 to-red-400 bg-clip-text text-transparent mb-2">
                {score}%
              </div>
              <div className="w-full h-3 bg-gray-700 rounded-full overflow-hidden mb-4">
                <div
                  className={`h-full rounded-full transition-all duration-1000 ${
                    ...
                    score >= 60 ? 'bg-gradient-to-r from-yellow-500 to-green-500' :
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <span className="px-3 py-1 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-xl text-green-400 font-semibold">
          ...
          <div className="bg-gray-800 rounded-2xl p-6 max-w-md w-full border border-gray-700 animate-scale-in">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="w-full px-4 py-3 bg-emerald-600 text-white font-medium rounded-xl hover:bg-emerald-700 transition-all"
              >
