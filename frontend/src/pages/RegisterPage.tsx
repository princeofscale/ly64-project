...
export default function RegisterPage() {
 ...
 () => students.filter(s => s.toLowerCase().includes(studentSearch.toLowerCase())).slice(0, 10),
 ...
 toast.error('Напишите о своей мотивации');
 return false;
 }
 ...
 <div className=" border border-slate-200 rounded-2xl p-8 shadow-xl shadow-slate-200/50 animate-fade-in" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
 <div className="text-center mb-8">
 <h1 className="text-2xl font-bold  mb-2" style={{ color: 'var(--color-text)' }}>Создать аккаунт</h1>
 ...
 <div>
 <label htmlFor="register-name" className="block text-sm font-medium text-slate-700 mb-2">Имя и фамилия</label>
 ...
 <div>
 <label htmlFor="register-password" className="block text-sm font-medium text-slate-700 mb-2">Пароль</label>
 <div className="relative">
 <div className="absolute left-4 top-1/2 -translate-y-1/2">
 ...
 <div>
 <label htmlFor="register-confirm-password" className="block text-sm font-medium text-slate-700 mb-2">Подтвердите пароль</label>
 <div className="relative">
 <div className="absolute left-4 top-1/2 -translate-y-1/2">
 <Lock className="w-5 h-5 text-slate-400" />
 </div>
 ...
 <label htmlFor="register-student-search" className="block text-sm font-medium text-slate-700 mb-2">
 Выберите своё имя из списка
 </label>
 <div className="relative">
 <input
 id="register-student-search"
 type="text"
 value={studentSearch}
 onChange={e => {
 ...
 <div className="absolute z-10 w-full mt-2  border border-slate-200 rounded-xl shadow-lg max-h-60 overflow-y-auto" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
 ...
 <div>
 <label htmlFor="register-grade" className="block text-sm font-medium text-slate-700 mb-2">Текущий класс</label>
 <select
 id="register-grade"
 ...
 {formData.status === 'APPLICANT' && (
 <div>
 <label htmlFor="register-direction" className="block text-sm font-medium text-slate-700 mb-2">
 ...
 <label htmlFor="register-terms" className="flex items-start gap-3 cursor-pointer p-4 rounded-xl hover:bg-slate-50 transition-colors">
 <input
 id="register-terms"
 type="checkbox"
 ...
 <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in" role="dialog" aria-modal="true" aria-labelledby="existing-email-title">
 <div className=" border border-slate-200 rounded-2xl shadow-2xl max-w-md w-full p-8 animate-scale-in" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
 <div className="text-center mb-6">
 <div className="mx-auto w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-4">
 <User className="w-8 h-8 text-blue-600" />
 </div>
 <h3 id="existing-email-title" className="text-xl font-bold text-slate-900 mb-2">Аккаунт уже существует</h3>
 ...
 void navigate('/login', { state: { email: formData.email } });
 }}
