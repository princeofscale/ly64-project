...
function PeriodicTablePage() {
 ...
 <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-500 via-blue-400 to-purple-500 bg-clip-text text-transparent mb-4">
 Таблица Менделеева
 </h1>
 <p className="text-slate-500">Нажмите на элемент для подробной информации</p>
 </div>

 {}
 <div className="max-w-md mx-auto mb-6">
 <label htmlFor="element-search" className="sr-only">Поиск элемента</label>
 <input
 id="element-search"
 type="text"
 value={searchQuery}
 ...
 className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:ring-blue-500/20 focus:outline-none"
 />
 </div>
 ...
 } ${selectedElement?.number === el.number ? 'ring-2 ring-blue-400' : ''}`}
 style={{
 ...
 {selectedElement && (
 <div className="mt-8 max-w-2xl mx-auto  border border-slate-200 rounded-2xl shadow-xl p-6" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
 ...
 <h2 className="text-2xl font-bold " style={{ color: 'var(--color-text)' }}>{selectedElement.nameRu}</h2>
 <p className="text-slate-500">{selectedElement.name}</p>
 <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
 <div>
 <span className="text-slate-400">Атомная масса:</span>
 <span className="text-slate-900 ml-2">{selectedElement.mass}</span>
 </div>
 <div>
 ...
 <div>
 <span className="text-slate-400">Электронная конфигурация:</span>
 <span className="text-slate-900 ml-2">{selectedElement.electron}</span>
 </div>
 <div>
 <span className="text-slate-400">Открыт:</span>
 <span className="text-slate-900 ml-2">{selectedElement.discovered}</span>
 </div>
 <div>
 <span className="text-slate-400">Группа:</span>
 <span className="text-slate-900 ml-2">{selectedElement.group}</span>
 </div>
 <div>
 <span className="text-slate-400">Период:</span>
 <span className="text-slate-900 ml-2">{selectedElement.period}</span>
 </div>
 </div>
 </div>
 </div>
