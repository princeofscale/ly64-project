...
function UnitConverterPage() {
 ...
 const secondUnit = units[1]?.id ?? firstUnit;
 setFromUnit(firstUnit);
 setToUnit(secondUnit);
 setFromValue('1');
 setToValue(convert('1', firstUnit, secondUnit));
 };
 ...
 {/* От */}
 <div>
 <label htmlFor="from-unit-select" className="block text-slate-700 text-sm font-medium mb-2">Из</label>
 <select
 id="from-unit-select"
 value={fromUnit}
 ...
 {/* В */}
 <div>
 <label htmlFor="to-unit-select" className="block text-slate-700 text-sm font-medium mb-2">В</label>
 <select
 id="to-unit-select"
 value={toUnit}
 ...
 <div
 key={unit.id}
 className=" border border-slate-200 shadow-sm rounded-xl p-4 text-center" style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
